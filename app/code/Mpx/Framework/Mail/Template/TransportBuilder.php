...
namespace Mpx\Framework\Mail\Template;
...
{
    public const DEFAULT_REPLYTO_MAIL = 'noreply@x-shopping-st.com';
    ...
    protected function prepareMessage()
    {
        ...
        if (!isset($this->messageData['replyTo'])) {
            $this->addAddressByType('replyTo', self::DEFAULT_REPLYTO_MAIL, null);
        }
